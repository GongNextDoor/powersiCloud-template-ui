  ...
  >
    <div class="box">
      ...
      >
        ...
        <template slot="files">
          <a class="link" href="#" title="xxx.doc">xxx.doc</a>
        </template>
      </table-items>
    </div>
  ...
  data() {
    return {
      itemsDatas: [
        ...
        [
          { label: '针对地区', prop: 'xxx', colspan: 5 }
        ],
        [
          { label: '主题词', prop: 'xxx', colspan: 3 },
          { label: '印发日期', prop: 'xxx', colspan: 1 }
        ],
        [
          { label: '内容主体', prop: 'xxx1', slot: 'mainContent', colspan: 5 }
        ],
        [
          { label: '备注', prop: 'xxx', colspan: 5 }
        ],
        [
          { label: '上传文件', prop: 'xxx', slot: 'files', colspan: 5 }
        ]
      ],
      formsDatas: {
        xxx: 'xxx',
        xxx1: `关于开展泌尿系“日间手术”病种按单病种
          包干结算试点工作的通知
          各三级定点医疗机构：
