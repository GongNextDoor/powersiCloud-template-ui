<!-- 知识库信息维护 -->
<template>
  <normal-layer :search-number="itemsDatas.length" title-name="知识库信息维护列表" title-need-handle>
...
export default {
  ...
  data() {
    return {
      ...
      itemsDatas: [
        ...
        { label: '是否公开', prop: 'xxx', type: 'select' },
  ...
  methods: {
    addEvent() {
      this.dialogTitle = '知识库信息新增'
      this.showEditDialog = true
    },
    editClick(row) {
      this.dialogTitle = '知识库信息编辑'
      this.showEditDialog = true
    },
    detailsClick(row) {
