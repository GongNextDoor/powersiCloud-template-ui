<template>
  ...
  <form-dialog title="入院登记" :is-show="show" width="760px" new-class="middle" @update:isShow="updateIsShow" @resetForm="resetForm">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <el-row :gutter="10">
            ...
            <el-col :span="12">
              <el-form-item label="医保就医号号" prop="type">
                <el-input v-model="form.no" placeholder="placeholder" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
